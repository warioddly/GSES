<?php $__env->startSection('panel'); ?>
    <div class="col-md-6 col-sm-12">
        <h3 class="animated fadeInLeft"><?php echo e(__('Create New Subject')); ?></h3>
    </div>
    <div class="col-md-6 col-sm-12">
        <div class="pull-right">
            <h3 class="animated fadeInRight">
                ...
                <button type="submit" class="btn btn-primary" form="subject-form"><?php echo e(__('Save')); ?></button>
            </h3>
        </div>
    </div>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(array('id'=>'subject-form', 'route' => 'modules.subjects.store','method'=>'POST', 'enctype'=>'multipart/form-data')); ?>
        ...
        <div id="collapse1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1"
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6 px-md-5 form-field">
                        <?php echo e(AppHelper::textBlade('note', __('Note'), null, true)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IMO\PhpstormProjects\GSES 2.2\GSES 2.0\resources\views/subjects/create.blade.php ENDPATH**/ ?>