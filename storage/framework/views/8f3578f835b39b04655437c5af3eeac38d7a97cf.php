<?php $__env->startSection('content'); ?>
    ...
    <div class="modal-body p-0">
        <form id="modal-form" method="POST" enctype="multipart/form-data"
              action="<?php echo e(route('modal-contractors.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="panel m-0">
...
<?php echo $__env->make('layouts.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IMO\PhpstormProjects\GSES 2.0\resources\views/modal-CRUDs/contractors/create.blade.php ENDPATH**/ ?>