...
<?php $__env->startPush('page-scripts'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contractor-create')): ?>
        <script>
            $('#show-contractor-modal').click(function () {
                ...
                $.ajax({
                    method: 'get',
                    url: '<?php echo e(route('modal-contractors.create')); ?>',
                    success: (data) => {
    ...
    <?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\IMO\PhpstormProjects\GSES 2.2\GSES 2.0\resources\views/uitypes/select_contractor.blade.php ENDPATH**/ ?>