<?php $__env->startSection('panel'); ?>
    <div class="col-md-6 col-sm-12">
        <h3 class="animated fadeInLeft"><?php echo e(__('Create New Contractor')); ?></h3>
    </div>
    <div class="col-md-6 col-sm-12">
        <div class="pull-right">
            <h3 class="animated fadeInRight">
                ...
                <button type="submit" class="btn btn-primary" form="contractor-form"><?php echo e(__('Save')); ?></button>
            </h3>
        </div>
    </div>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(array('id'=>'contractor-form', 'route' => 'modules.contractors.store','method'=>'POST', 'enctype'=>'multipart/form-data')); ?>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6 px-md-5 form-field type-depended-elements">
                        <?php echo e(AppHelper::selectBlade('organ_id', __('Contractor organ'), [null=>__('Search for an item')] + $organs, null, true)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IMO\PhpstormProjects\GSES 2.2\GSES 2.0\resources\views/contractors/create.blade.php ENDPATH**/ ?>