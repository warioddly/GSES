...
unset($__errorArgs, $__bag); ?>"
       >
    <?php echo Form::file($fieldName, array('class' => 'form-text fileName ', 'style'=>'opacity:0;position:absolute;z-index:1;')+($required?['required']:[])); ?>

    <div class="input-group">
        <?php if($document != null): ?>
            <?php echo Form::hidden(str_replace(']_id', '_id]', $fieldName.'_id'), $document->id, array('class' => 'form-text fileName file-id')); ?>
        ...
        <?php else: ?>
            <input type="text" class="form-text fileName file-name<?php echo e($errors->has($fieldName)?' error':''); ?>" value="" readonly>
            <span class="input-group-addon"><i class="fas fa-paperclip" title="<?php echo e(__('Choose')); ?>"></i></span>
            ...
            <span class="input-group-addon file-clear" style="z-index: 2;position: sticky;background: none;display:none;">
                <i class="fas fa-times" title="<?php echo e(__('Clear')); ?>"></i>
            </span>
        <?php endif; ?>
    </div>
    <span class="bar"></span>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\IMO\PhpstormProjects\GSES 2.2\GSES 2.0\resources\views/uitypes/file.blade.php ENDPATH**/ ?>