    ...
    <div class="col-md-6 col-sm-12">
        <div class="pull-right">
            <h3 class="animated fadeInRight">
                ...
                <button type="submit" class="btn btn-primary" form="modules-expertiseArticle-form">{{__('Save')}}</button>
            </h3>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    @endif
    {!! Form::model($expertiseArticle, ['id'=>'modules-expertiseArticle-form', 'method' => 'PATCH', 'route' => ['modules.expertiseArticles.update', $expertiseArticle->id], 'enctype'=>'multipart/form-data']) !!}
    <div class="panel">
