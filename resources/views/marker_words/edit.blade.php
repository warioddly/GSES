...
@section('panel')
    <div class="col-md-6 col-sm-12">
        <h3 class="animated fadeInLeft">{{__('Edit Word')}}</h3>
    </div>
    <div class="col-md-6 col-sm-12">
...
@section('content')
    ...
    {!! Form::model($marker_word, array('id'=>'modules-marker-form','method'=>'PATCH', 'route' => ['modules.marker_words.update', $marker_word->id], 'enctype'=>'multipart/form-data')) !!}
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6 px-md-5 form-multi-field">
                        {{AppHelper::selectMultipleBlade('declensions', __('Declension'), $declensions, array_keys($declensions), false, false, route('getDeclensions'))}}
                    </div>
                    <div class="col-md-6 px-md-5 form-multi-field">
