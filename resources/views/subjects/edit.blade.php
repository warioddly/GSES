    ...
    <div class="col-md-6 col-sm-12">
        <div class="pull-right">
            <h3 class="animated fadeInRight">
                ...
                <button type="submit" class="btn btn-primary" form="modules-subject-form">{{__('Save')}}</button>
            </h3>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    {!! Form::model($subject, ['id'=>'modules-subject-form', 'method' => 'PATCH', 'route' => ['modules.subjects.update', $subject->id], 'enctype'=>'multipart/form-data']) !!}
    <div class="panel">
