...
@section('panel')
    <div class="col-md-6 col-sm-12">
        <h3 class="animated fadeInLeft">{{__('Create New Analyze')}}</h3>
    </div>
    <div class="col-md-6 col-sm-12">
...
@section('content')
    ...
    {!! Form::open(array('id'=>'analyze-form', 'route' => 'materials.analyzes.store','method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
        ...
        <div id="collapse1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1" aria-expanded="true" style="">
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6 px-md-5 form-multi-field">
                        {{AppHelper::textareaBlade('result', __('Found text'), null, true)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::textBlade('coefficient', __('Coincidence rate'))}}
                    </div>
                </div>
            </div>
        </div>
