...
@section('panel')
    <div class="col-md-6 col-sm-12">
        <h3 class="animated fadeInLeft">{{__('Create New Template')}}</h3>
    </div>
    <div class="col-md-6 col-sm-12">
        <div class="pull-right">
            <h3 class="animated fadeInRight">
                <a class="btn btn-default" href="{{ route('modules.templates.index') }}"> {{__('Close')}}</a>
                <button type="submit" class="btn btn-primary" form="templates-form">{{__('Save')}}</button>
            </h3>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    {!! Form::open(array('id'=>'templates-form', 'route' => 'modules.templates.store','method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
    ...
    <div class="panel">
        ...
        <div id="collapse1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1" aria-expanded="true" style="">
            ...
            <div class="row">
                ...
                <div class="col-md-6 px-md-5 form-field">
                    {{AppHelper::fileBlade('document', __('Document'), null, true)}}
                </div>
                <div class="col-md-6 px-md-5 form-field">
