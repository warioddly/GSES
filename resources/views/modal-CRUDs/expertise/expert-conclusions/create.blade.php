...
<div class="modal-body p-0">
    {!! Form::open(['id'=>'modal-form', 'method' => 'POST', 'route' => 'expertise.modal.conclusions.store', 'enctype'=>'multipart/form-data']) !!}
    <div class="panel m-0">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::selectMultipleBlade('materials', __('Materials'), $materials, null, true)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
