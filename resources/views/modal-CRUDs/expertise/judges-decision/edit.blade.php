...
<div class="modal-body p-0">
    {!! Form::model($decision, ['id'=>'modal-form', 'method' => 'PATCH', 'route' => ['expertise.modal.decisions.update',$decision->id], 'enctype'=>'multipart/form-data']) !!}
    <div class="panel m-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::dependedSelectBlade(
                            ...
                            true,
                            'court_id',
                            $courtRelation,'#CRUD-modal')}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::dateBlade('date', __('Date'),$decision->date->format('d-m-Y'), true)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::textBlade('comment', __('Comment'), null, false)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::fileBlade('file', __('Attach source file'), $decision->file, false)}}
                    </div>
