...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="analyzeEditModalLabel">{{__('Edit Expert Task')}}</h4>
</div>
<div class="modal-body p-0">
    {!! Form::model($expert_task, ['id'=>'modal-form', 'method' => 'PATCH', 'route' => ['expertise.modal.expert-tasks.update',$expert_task->id], 'enctype'=>'multipart/form-data']) !!}
    <div class="panel m-0">
        ...
        <div id="create-conclusion-modal" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1"
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::dateBlade('date_start', __('Date start task'), $expert_task->date_start?$expert_task->date_start->format('d-m-Y'):null, true)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::dateBlade('date_end', __('Date end task'), $expert_task->date_end?$expert_task->date_end->format('d-m-Y'):null, true)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::textBlade('comment', __('Comment'), null, false)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::selectMultipleBlade('experts', __('Responsible'), $experts, $expert_task->experts, true)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
