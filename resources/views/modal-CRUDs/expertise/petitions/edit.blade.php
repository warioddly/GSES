...
@section('content')
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="analyzeEditModalLabel">{{__('Edit Petition')}}</h4>
    </div>
    <div class="modal-body p-0">
        {!! Form::model($petition, ['id'=>'modal-form', 'method' => 'PATCH', 'route' => ['expertise.modal.petitions.update',$petition->id], 'enctype'=>'multipart/form-data']) !!}
        <div class="panel m-0">
            ...
            <div id="create-conclusion-modal" class="panel-collapse collapse in" role="tabpanel"
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 px-md-5 form-field">
                            {{AppHelper::fileBlade('file', __('Attach source file'), $petition->scan)}}
                        </div>
                        <div class="col-md-6 px-md-5 form-field">
