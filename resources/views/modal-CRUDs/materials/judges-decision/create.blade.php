...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="analyzeEditModalLabel">{{__('Create Decision')}}</h4>
</div>
<div class="modal-body p-0">
    {!! Form::open(['id'=>'modal-form', 'method' => 'POST', 'route' => 'material.modal.decisions.store', 'enctype'=>'multipart/form-data']) !!}
    <div class="panel m-0">
        ...
        <div id="create-conclusion-modal" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1"
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::dateBlade('date', __('Date court decision'), null, true)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
