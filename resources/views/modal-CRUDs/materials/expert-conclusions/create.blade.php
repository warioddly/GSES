...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="analyzeEditModalLabel">{{__('Create Conclusion')}}</h4>
</div>
<div class="modal-body p-0">
    {!! Form::open(['id'=>'modal-form', 'method' => 'POST', 'route' => 'material.modal.conclusions.store', 'enctype'=>'multipart/form-data']) !!}
    <div class="panel m-0">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6 px-md-5 form-field">
                        {{AppHelper::selectMultipleBlade('options', __('Conclusion'), $options, [],true)}}
                    </div>
                    ...
                    <div class="col-md-6 px-md-5 form-field hide">
                        {{AppHelper::selectMultipleBlade('materials', __('Materials'), $materials, array_keys($materials),true)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
