...
@section('panel')
    <div class="col-md-6 col-sm-12">
        <h3 class="animated fadeInLeft">{{__('Edit Settings Report')}}</h3>
    </div>
    <div class="col-md-6 col-sm-12">
        <div class="pull-right">
            <h3 class="animated fadeInRight">
                <a class="btn btn-default" href="{{ route('settings.reports.index') }}"> {{__('Close')}}</a>
                <button type="submit" class="btn btn-primary" form="settings-report-form">{{__('Save')}}</button>
            </h3>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    {!! Form::model($report, ['id'=>'settings-report-form', 'method' => 'PATCH', 'route' => ['settings.reports.update', $report->id], 'enctype'=>'multipart/form-data']) !!}
    <div class="panel">
