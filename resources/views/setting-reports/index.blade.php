...
@section('panel')
    <div class="col-md-6 col-sm-12">
        <h3 class="animated fadeInLeft">{{__('Reports')}}</h3>
    </div>
    <div class="col-md-6 col-sm-12">
        <div class="pull-right">
            @can('setting-report-create')
            <h3 class="animated fadeInRight"><a class="btn btn-success" href="{{ route('settings.reports.create') }}"> {{__('Create New Report')}}</a></h3>
            @endcan
        </div>
    </div>
@endsection
            ...
            <div class="responsive-table">
                ...
                <thead>
                    <tr>
                        ...
                        <th data-title="{{__('Description')}}">{{__('Description')}}</th>
...
<script>
    $('#report-table').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": '{{route('settings.reports.index')}}',
        "columns": [
            {data: 'id', name: 'id'},
            {data: 'name', name: 'name'},
