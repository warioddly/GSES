...
@section('content')
    ...
    {!! Form::open(array('id'=>'modules-marker-form', 'route' => 'modules.marker_black_words.store','method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
    ...
    <div class="panel">
        ...
        <div id="collapse1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1" aria-expanded="true" style="">
            ...
            <div class="row">
                ...
                <div class="col-md-6 px-md-5 form-field">
                    {{AppHelper::textBlade('comment', __('Comment'), null, true)}}
                </div>
