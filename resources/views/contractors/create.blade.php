...
@section('panel')
    <div class="col-md-6 col-sm-12">
        <h3 class="animated fadeInLeft">{{__('Create New Contractor')}}</h3>
    </div>
    <div class="col-md-6 col-sm-12">
        <div class="pull-right">
            <h3 class="animated fadeInRight">
                <a class="btn btn-default" href="{{ route('modules.contractors.index') }}"> {{__('Close')}}</a>
                <button type="submit" class="btn btn-primary" form="contractor-form">{{__('Save')}}</button>
            </h3>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    {!! Form::open(array('id'=>'contractor-form', 'route' => 'modules.contractors.store','method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6 px-md-5 form-field type-depended-elements">
                        {{AppHelper::selectBlade('organ_id', __('Contractor organ'), [null=>__('Search for an item')] + $organs, null, true)}}
                    </div>
                    <div class="col-md-6 px-md-5 form-field">
